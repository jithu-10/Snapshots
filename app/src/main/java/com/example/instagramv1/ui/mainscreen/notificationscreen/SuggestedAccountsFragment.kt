...
import com.example.instagramv1.adapters.SuggestedAccountsRecyclerAdapter
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.launch

@AndroidEntryPoint
class SuggestedAccountsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if(fragmentView == null){
            ...
            val suggestedAccountsRecyclerAdapter = SuggestedAccountsRecyclerAdapter(viewModel)
            suggestedAccountsRecyclerAdapter.stateRestorationPolicy = RecyclerView.Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY
            recyclerView.adapter = suggestedAccountsRecyclerAdapter
            ...
            lifecycleScope.launch {
                viewModel.getSuggestedUsers().observe(requireActivity()){
                    suggestedAccountsRecyclerAdapter.setSuggestedUsers(it)
