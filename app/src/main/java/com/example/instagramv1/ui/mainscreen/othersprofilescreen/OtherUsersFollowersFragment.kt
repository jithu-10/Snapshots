...
@AndroidEntryPoint
class OtherUsersFollowersFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_other_users_followers, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch{
            viewModel.getFollowers(otherUserId).observe(viewLifecycleOwner){
