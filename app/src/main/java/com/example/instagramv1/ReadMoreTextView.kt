...
class ReadMoreTextView @JvmOverloads constructor(
    ...
    private fun setupAttributes(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        numberOfBoldCharFromStart =
            typedArray.getInt(R.styleable.ReadMoreTextView_numberOfBoldCharFromStart, numberOfBoldCharFromStart)
        typedArray.recycle()
    }
    ...
    private fun setupReadMore() {
        ...
        val spannableString = SpannableString(collapseText)
        val boldSpan = StyleSpan(Typeface.BOLD)
        spannableString.setSpan(boldSpan, 0, numberOfBoldCharFromStart, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        collapseText = spannableString
        text = collapseText
